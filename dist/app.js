...
var Rx_1 = __webpack_require__(70);
var Redxjs = /** @class */ (function () {
    function Redxjs(_name) {
        this._name = _name;
    }
    Redxjs.prototype.Actions = function (name) {
        var obs = Rx_1.Observable.fromEvent(document, 'click');
        obs.subscribe(function () {
            console.log('hi');
        });
    };
    Redxjs.prototype.combineReducer = function (reducers) {
    ...
    Redxjs.prototype.dispatch = function (action) {
    };
    return Redxjs;
}());
exports.Redxjs = Redxjs;
